...
python3 -m venv /opt/app/iddotme/env
source /opt/app/iddotme/env/bin/activate
pip3 install -r /opt/app/iddotme/requirements.txt
...
# Start application
cd /opt/app/
gunicorn iddotme.main:app -b 0.0.0.0:80